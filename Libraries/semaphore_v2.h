...
static const int SEM_constructor_with_name(semaphore * sem, key_t key) {
 ...
 * @return int The result of the operation executed
 */
static const int SEM_constructor (semaphore * sem)
{
	assert (sem != NULL);
 ...
 * @return int The result of the operation executed
 */
static const int SEM_init (const semaphore * sem, const int v)
{
 ...
 * @return int The result of the operation executed
 */
static const int SEM_destructor (const semaphore * sem)
{
	assert (sem != NULL);
 ...
 * @return int The result of the operation executed
 */
static const int SEM_wait (const semaphore * sem)
{
 ...
 * @return int The result of the operation executed
 */
 static const int SEM_signal (const semaphore * sem)
{
	struct sembuf o = {0, 1, SEM_UNDO};
	assert (sem != NULL);
	return semop(sem->shmid, &o, 1);
